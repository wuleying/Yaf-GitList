...
<title><?php echo Yaf\Registry::get('lang')->translate('Website maintenance');?> - <?php echo Yaf\Registry::get('setting')['sitedescription']; ?></title>
...
<body>
	...
	<div class="panel panel-primary error">
		<div class="panel-heading"><h3 class="panel-title"><?php echo Yaf\Registry::get('lang')->translate('Website maintenance');?></h3></div>
