...
<title><?php echo Yaf\Registry::get('lang')->translate('Wrong');?> - <?php echo Yaf\Registry::get('setting')['sitedescription']; ?></title>
...
<body>
	...
	<div class="panel panel-warning error">
		<div class="panel-heading"><h3 class="panel-title"><?php echo Yaf\Registry::get('lang')->translate('Wrong');?>!</h3></div>
